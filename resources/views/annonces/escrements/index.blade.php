<x-app-layout>
        ...
        <div class="py-12" style="background: linear-gradient(135deg, var(--color-primary), var(--color-primary-dark));">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold text-white flex items-center gap-3">
                    <i class="fas fa-leaf text-4xl" style="color: var(--color-primary-light);"></i>
                    Escrements & Fumier
                </h1>
                <p class="mt-2" style="color: var(--color-secondary-light);">Découvrez notre sélection d'engrais naturels de qualité pour vos cultures</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-8" style="background-color: var(--color-bg-body);">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <form action="{{ route('annonce.escrement.index') }}" method="GET" id="filter-form">
                    <div class="rounded-xl shadow-md p-6" style="background-color: var(--color-bg-white);">
                        ...
                        <div class="flex flex-col md:flex-row gap-4 mb-4">
                            <div class="flex-1">
                                <div class="relative">
                                    <input type="text" 
                                           ...
                                           placeholder="Rechercher un escrement par nom, type, espèce..." 
                            ...
                            @if(request()->anyFilled(['search', 'espece', 'vendeur_nom', 'prix_min', 'prix_max', 'sort']))
                                <a href="{{ route('annonce.escrement.index') }}" 
            ...
            @else
                <div class="text-center py-16 rounded-xl" style="background-color: var(--color-bg-white);">
                    <i class="fas fa-leaf text-6xl mb-4" style="color: var(--color-primary-light);"></i>
                    <h3 class="text-2xl font-bold mb-2" style="color: var(--color-nav-text);">Aucune annonce trouvée</h3>
                    <p style="color: var(--color-nav-text); opacity: 0.6;">Aucun escrement ne correspond à vos critères de recherche.</p>
                    <a href="{{ route('annonce.escrement.index') }}" class="inline-block mt-4 px-6 py-2 rounded-lg text-white transition hover:scale-105" 
                       style="background: linear-gradient(135deg, var(--color-primary), var(--color-primary-dark));">
